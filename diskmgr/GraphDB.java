...
public class GraphDB extends DB
        {
            ...
            BTreeFile nodeLabels_BFile;
            BTreeFile edgeLabels_BFile;
            BTreeFile edgeSourceLabels_BFile;
            BTreeFile edgeDestinationLabels_BFile;
            BTreeFile edgeWeights_BFile;

            ZTreeFile nodesDescriptors_ZFile;

            static int Graphcounter;
            int GraphID;
            int type;

            HashMap<String,Integer> hashLabelsPresent;
            HashMap<String,Integer> hashSourceNodesPresent;
            HashMap<String,Integer> hashDestinationNodesPresent;
