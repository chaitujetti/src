...
public class Tuple implements GlobalConst{
    ...
    public  void setTupleOffset(int tuple_offset)
    {
    ...
    public void setTupleLength(int tuple_length)
    {
    ...
    public void setFieldCount(short fldCnt)
    {
        this.fldCnt=fldCnt;
    }
    ...
    public void setFieldOffset(short[] fldOffset)
    {
...
//       fldOffset = fromTuple.copyFldOffset();
    ...
    /**
     * Convert this field into a descriptor
     *
     * @param    fldNo   the field number
     * @return           the descriptor if success
     *
     * @exception   IOException I/O errors
     * @exception   FieldNumberOutOfBoundException Tuple field number out of bound
     */
     ...
     *
     * @param fldNo the field number
     * @param val the descriptor value
     * @exception   IOException I/O errors
     * @exception   FieldNumberOutOfBoundException Tuple field number out of bound
     */
